...
public class Edit {
	...
	public static void main(String[] args) {
		//setup the path
				...
				//enter the mail id
				driver.findElement(By.xpath("//input[@id='email']")).sendKeys("babyganeshece@gmail.com");
				//Append a text and press keyboard tab
				driver.findElement(By.xpath("//label[contains(text(),'Append')]/following::input")).sendKeys("BABY,keys.TAP");
